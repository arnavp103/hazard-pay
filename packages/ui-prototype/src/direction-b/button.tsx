...
const buttonVariants = cva(
  "inline-flex cursor-pointer items-center justify-center gap-2 border-2 font-display font-bold uppercase transition-all duration-75 outline-none select-none focus-visible:ring-2 focus-visible:ring-info active:translate-x-[3px] active:translate-y-[3px] active:shadow-none disabled:cursor-not-allowed disabled:opacity-40",
  {
    variants: {
      variant: {
        primary: "border-accent-2 bg-accent-2 text-shell shadow-[4px_4px_0_0_var(--hp-accent)] hover:brightness-110",
        ghost: "border-accent bg-transparent text-accent shadow-[4px_4px_0_0_rgba(0,0,0,0.5)] hover:bg-accent/15",
        danger: "border-danger bg-danger/15 text-danger shadow-[4px_4px_0_0_rgba(0,0,0,0.5)] hover:bg-danger/30",
      },
      size: {
