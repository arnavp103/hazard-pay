/**
 * THROWAWAY SCAFFOLDING (#96, ported from #89): the *authored* half of the
 * animation hypothesis.
 *
 * #89 asked how minimal the authored base can get before motion quality
...
export type AuthoredMode = "additive" | "off" | "replace";
 ...
 */
export const AUTHORED_MODE: Record<BaseDensity, AuthoredMode> = {
  none: "off",
  pair: "replace",
  quad: "replace",
  stance: "additive",
